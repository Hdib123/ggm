...
if ($name == "") {
    ...
    $to = 'orcadrak85@gmail.com';
    $subject = 'GGM Contact Query';
    ...
    $headers .= 'From:  GGM <orcadrak85@gmail.com>' . "\r\n";
    $headers .= 'cc: orcadrak85@gmail.com' . "\r\n";
    $headers .= 'bcc: orcadrak85@gmail.com' . "\r\n";
    mail($to, $subject, $_message, $headers, '-f orcadrak85@gmail.com');
